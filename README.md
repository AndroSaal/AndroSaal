...
- End-to-end product development mindset: from system design to production support.
- Confident in architecture decisions and ownership of business-critical services.
- Strong background in complex external integrations (payments, logistics, enterprise systems, LLM-related workflows).
- Hands-on performance optimization at both service and platform levels.
- English level: C1.
...
![WebSockets](https://img.shields.io/badge/WebSockets-4A4A55?style=for-the-badge&logo=socketdotio&logoColor=white)
